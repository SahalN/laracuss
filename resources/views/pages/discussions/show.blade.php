        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                                    ...
                                    <div class="col-5 col-lg-3 d-flex">
                                        ...
                                        <div class="fs-12px lh-1">
                                            <span class="text-primary">
                                                <a href="#"
                                                    class="fw-bold d-flex align-items-start text-break mb-1">SahalN</a>
                                            </span>
                    ...
                    <div class="fw-bold text-center">Please <a href="#" class="text-primary">sign in</a> or <a
                            href="#" class="text-primary">create an account</a> to
                        participate in this
                        discussion.
